#يمنع بيع الادات
#يمنع تغيير الحقوق
#نعن غير مسوولين عن اي تغيير داخل الادات
#اني غير مسوول عن اي ستخدام خاطا
import os
import shutil
import random
import threading
...
TOKEN = '7522604293:AAHVU5UKcxfdxdJgtoubYFyZ6UxnBqw6i48' #توكن بوتك التلكرام بدل كلمه. token
ADMIN_ID = 8142432123
#ايدي حسابك تلكرام  بدل كلمهID
bot = TeleBot(TOKEN)
